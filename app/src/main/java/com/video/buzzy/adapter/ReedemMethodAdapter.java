...
import com.video.buzzy.databinding.ItemReedemMethodBinding;
    ...
    public class ReedemMethodViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            if (selectedPos == position) {
                ...
                binding.lytMain.setBackgroundTintList(ContextCompat.getColorStateList(context, R.color.icon_color));
            }
