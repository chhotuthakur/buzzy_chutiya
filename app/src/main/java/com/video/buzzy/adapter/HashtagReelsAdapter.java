...
public class HashtagReelsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == AD_TYPE) {
            ...
            return new HashtagReelsViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_reels, parent, false));
        }
    }
...
//        return super.getItemViewType(position);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MultipleCustomNativeAds.UnifiedNativeAdViewHolder) {
            ...
            ((HashtagReelsAdapter.HashtagReelsViewHolder) holder).setData(position);
        }
    }
    ...
    public void addData(List<HashtagVideoRoot.ReelItem> reels) {
    ...
    public interface OnReelsVideoAdapterListner {
        ...
        void onDoubleClick(HashtagVideoRoot.ReelItem model, MotionEvent event, ItemReelsBinding binding);

        void onClickLike(ItemReelsBinding reelsBinding, int pos);

        void onClickUser(HashtagVideoRoot.ReelItem reel);

        void onClickComments(HashtagVideoRoot.ReelItem reels);

        void onClickShare(HashtagVideoRoot.ReelItem reel);

        void onClickGift(HashtagVideoRoot.ReelItem reelItem);

        void onClickProduct(HashtagVideoRoot.ReelItem reelItem);
    ...
    public class HashtagReelsViewHolder extends RecyclerView.ViewHolder {
        ItemReelsBinding binding;

        public HashtagReelsViewHolder(View itemView) {
            super(itemView);
            binding = ItemReelsBinding.bind(itemView);
        }

        public void setData(int position) {
            HashtagVideoRoot.ReelItem reel = (HashtagVideoRoot.ReelItem) reels.get(position);
...
//            Log.d("TAG", "setData: " + reels.get(0).isIsLike());
//
...
//                i.putExtra(Const.URL, "https://www.myntra.com/");
