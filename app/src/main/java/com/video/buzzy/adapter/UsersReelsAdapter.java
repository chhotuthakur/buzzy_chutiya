...
public class UsersReelsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//        return super.getItemViewType(position);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MultipleCustomNativeAds.UnifiedNativeAdViewHolder) {
            ...
            ((UsersReelsAdapter.HashtagReelsViewHolder) holder).setData(position);
        }
    }
    ...
    public class HashtagReelsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            try {
                ...
                //Log.d(">>>>>", "setData: " + reel.getUser().getProfileImage());
