...
public class User {
    ...
    public User(String name, String bio, String username, String email, String image, String country, int level, int followres, int fans, int videos, int age, int coin, int posts, int id, String gender) {
        this.name = name;
        this.bio = bio;
